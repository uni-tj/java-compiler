...
system = Class
  ...
  , cextends      = Just $ withAuthGen "java/lang/Object"
  , cfields       =
      [ Field{ fposition = AutoGenerated, foverride = withAuthGen False, faccess = withAuthGen Public, fstatic = withAuthGen True, ftype = withAuthGen $ Type.Instance "java/io/PrintStream", fname = withAuthGen "out", finit = Nothing }
      ]
  , cmethods      = []
